...
- 서버와 유저가 데이터를 주고받으려면 http 요청을 날리면 된다.
- http로 통신하게되면 클라이언트 쪽에서만 서버에 request를 보낼 수 있고, 서버 쪽에서 먼저 요청을 보낼 수 없다. (단방향 메세지 교환)
- WebSocket API를 사용하면 tcp 연결을 기반으로 클라이언트와 서버가 양방향 통신 가능하다.
- 실시간 양방향 웹
- WebSocket protocol `ws://` secure `wss://`
...
<img width="600" src="https://12devsofxmas.co.uk/wp-content/uploads/sites/2/2012/01/hierarchy.png"/>
...
<img height="200" width="200" alt="normal" src="https://threejs-journey.com/assets/lessons/11/003.jpg"></div>

<div style="display: flex; flex-direction: row;"><img height="200" width="200" alt="ambient occlusion" src="https://threejs-journey.com/assets/lessons/11/004.jpg">
<img height="200" width="200" alt="metalness" src="https://threejs-journey.com/assets/lessons/11/005.jpg">
<img height="200" width="200" alt="roughness" src="https://threejs-journey.com/assets/lessons/11/006.jpg"></div>
